...
function getLocal(latitude, longitude) {
    $.get("//api.openweathermap.org/data/2.5/forecast/daily", {
        ...
        console.log(data);
        $("#location").html("<div class='col-md-4 col-sm-12'><h2 style='color: cadetblue'>Today in </h2>" + "<h3>" + data.city.name + " " + data.city.country+ "</h3>" + "<img src='//openweathermap.org/img/w/" + data.list[0].weather[0].icon + ".png'>" + " <h4>Temperature: " + data.list[0].temp.day + " F</h4>" + " <h4> Morning: " + data.list[0].temp.morn + " F</h4>" + " <h4> Evening: " + data.list[0].temp.eve + " F" + "</h4></div>" +
